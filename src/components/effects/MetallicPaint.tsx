...
export default function MetallicPaint({ imageData, params = defaultParams }: { imageData: ImageData; params?: MetallicPaintParams }) {
  ...
  useEffect(() => {
    ...
    function render(currentTime: number) {
      ...
      totalAnimationTime.current += deltaTime * (params.speed || 0.3);
