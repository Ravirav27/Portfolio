...
const CYAN_PURPLE_CONFIG = {
  gap: 5,
  speed: 70,
  colors: '#7df9ff,#00d9ff,#a78bfa,#7c3aed',
};

export function PixelHoverEffect({ containerRef, variant = 'pink' }) {
  const config = variant === 'cyan' ? CYAN_PURPLE_CONFIG : PINK_CONFIG;
